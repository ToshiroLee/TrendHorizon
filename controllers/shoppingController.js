...
const getAllTrends = (req, res) => {
    ...
    pool.query('SELECT * FROM trends', (error, trends) => {
        ...
        res.render('shopping', { user: req.session.user, trends: trends, category: 'All Investment Types' });
    });
};
...
const getStocks = (req, res) => {
    ...
    pool.query('SELECT * FROM trends WHERE category = "stocks"', (error, trends) => {
        ...
        res.render('shopping', { user: req.session.user, trends: trends, category: 'Stocks' });
    });
};
...
const getCrypto = (req, res) => {
    ...
    pool.query('SELECT * FROM trends WHERE category = "crypto"', (error, trends) => {
        ...
        res.render('shopping', { user: req.session.user, trends: trends, category: 'Crypto' });
    });
};
